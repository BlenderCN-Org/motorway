...
{
    fpsSamples[currentSampleIdx % SAMPLE_COUNT] = 1.0f / frameTime;
    ...
    MinFramePerSecond = std::min( MinFramePerSecond, fps );
    MaxFramePerSecond = std::max( MaxFramePerSecond, fps );
    ...
    MinDeltaTime = std::min( MinDeltaTime, dt );
