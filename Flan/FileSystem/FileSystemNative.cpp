...
FileSystemNative::FileSystemNative( const fnString_t& customWorkingDirectory )
{
...
FileSystemObject* FileSystemNative::openFile( const fnString_t& filename, const int32_t mode )
{
...
void FileSystemNative::createFolder( const fnString_t& folderName )
{
    CreateFolderImpl( folderName );
}

bool FileSystemNative::fileExists( const fnString_t& filename )
{
...
fnString_t FileSystemNative::resolveFilename( const fnString_t& mountPoint, const fnString_t& filename )
{
    fnString_t resolvedFilename( filename );
