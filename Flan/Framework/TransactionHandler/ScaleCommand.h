...
{
public:
    LocalScaleCommand( Transform* transformToEdit, const glm::vec3& scaleValue )
...
private:
    Transform*  transform;
    glm::vec3   scale;
    glm::vec3   scaleBackup;
};

class WorldScaleCommand : public TransactionCommand
{
public:
    WorldScaleCommand( Transform* transformToEdit, const glm::vec3& scaleValue )
        : transform( transformToEdit )
        , scale( scaleValue )
        , scaleBackup( 0, 0, 0 )
    {
