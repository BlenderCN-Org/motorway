...
constexpr unsigned int num_precomputed_wavelengths = use_luminance_ == ATMOSPHERE_LUMINANCE_PRECOMPUTED ? 15 : 3;
constexpr unsigned int num_scattering_orders = 4;

static constexpr double kLambdaR = 680.0;
static constexpr double kLambdaG = 550.0;
static constexpr double kLambdaB = 440.0;

static constexpr fnChar_t* ATMOSPHERE_TRANSMITTANCE_TEXTURE_NAME = ( fnChar_t* const )FLAN_STRING( "GameData/Textures/AtmosphereTransmittance.dds" );
static constexpr fnChar_t* ATMOSPHERE_SCATTERING_TEXTURE_NAME = ( fnChar_t* const )FLAN_STRING( "GameData/Textures/AtmosphereScattering.dds" );
static constexpr fnChar_t* ATMOSPHERE_IRRADIANCE_TEXTURE_NAME = ( fnChar_t* const )FLAN_STRING( "GameData/Textures/AtmosphereIrradiance.dds" );
