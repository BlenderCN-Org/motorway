    ...
    : exposureTarget( 0 )
{
    ...
    parameters._clip_shadows = 0.0f;				// (0.0) Shadow cropping in histogram (first buckets will be ignored, leading to brighter image)
    parameters._clip_highlights = 1.0f;			    // (1.0) Highlights cropping in histogram (last buckets will be ignored, leading to darker image)
    ...
    parameters._reference_camera_fps = 15.0f;		// (30.0) Default camera at 30 FPS
