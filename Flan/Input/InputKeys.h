...
#define InputKey( option )\
        ...
        FLAN_LAZY_ENUM( InputKey )
#undef InputKey

        // Keyboard key count
        static constexpr int KEYBOARD_KEY_COUNT = 256;

        static constexpr flan::core::eInputKey UnixKeys[KEYBOARD_KEY_COUNT] =
        {
            KEY_NONE,
            KEY_NONE,
            KEY_NONE,
        ...
        static constexpr flan::core::eInputKey WindowsKeys[KEYBOARD_KEY_COUNT] =
        {
            KEY_NONE,
        ...
        static constexpr auto key = WindowsKeys[0x3E];
    }
}
