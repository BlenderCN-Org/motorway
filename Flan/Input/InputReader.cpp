...
void InputReader::create()
{
    ...
    FLAN_CLOG << "Active keyboard layout: " << activeInputLayout << std::endl;
}
...
flan::core::eInputLayout InputReader::getActiveInputLayout() const
{
...
std::vector<flan::core::eInputKey> InputReader::getAndFlushKeyStrokes()
{
...
void InputReader::setAbsoluteAxisValue( const flan::core::eInputAxis axis, const double absoluteValue )
{
    absoluteAxisValues[axis] = absoluteValue;
}

double InputReader::getAbsoluteAxisValue( const flan::core::eInputAxis axis )
{
