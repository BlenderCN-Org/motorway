...
{
public:
    LocalRotateCommand( Transform* transformToEdit, const nyaQuatf& rotationValue )
...
private:
    Transform*  transform;
    nyaQuatf   rotate;
    nyaQuatf   rotateBackup;
};

class WorldRotateCommand : public TransactionCommand
{
public:
    WorldRotateCommand( Transform* transformToEdit, const nyaQuatf& rotationValue )
        : transform( transformToEdit )
        , rotate( rotationValue )
        , rotateBackup( 1, 0, 0, 0 )
    {
