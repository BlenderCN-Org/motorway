...
void nya::core::LoadWaveFile( FileSystemObject* stream, Wave& wave )
{
    ...
    if ( numChannels == 1 ) {
        ...
        case 8:
            wave.audioFormat = nya::audio::eAudioFormat::AUDIO_FORMAT_8_MONO;
            break;
        case 16:
            wave.audioFormat = nya::audio::eAudioFormat::AUDIO_FORMAT_16_MONO;
            break;
        case 32:
            wave.audioFormat = nya::audio::eAudioFormat::AUDIO_FORMAT_32_MONO;
            break;
        }
    } else if ( numChannels == 2 ) {
        switch ( bitsPerSample ) {
        case 8:
            wave.audioFormat = nya::audio::eAudioFormat::AUDIO_FORMAT_8_STEREO;
            break;
        case 16:
            wave.audioFormat = nya::audio::eAudioFormat::AUDIO_FORMAT_16_STEREO;
            break;
        case 32:
            wave.audioFormat = nya::audio::eAudioFormat::AUDIO_FORMAT_32_STEREO;
            break;
        }
    }
