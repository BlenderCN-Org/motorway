...
float RadicalInverseBase2( const uint32_t bits )
{
...
namespace nya
{
    namespace maths
    {
        ...
        {
            return nyaVec2f( static_cast< float >( sampleIndex ) / static_cast< float >( sampleCount ), RadicalInverseBase2( sampleIndex ) );
        }
    }
}
