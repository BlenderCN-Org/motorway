...
void CommandList::updateTexture( Texture* texture, const void* data, const size_t dataSize )
{
    ...
    if ( SUCCEEDED( operationResult ) ) {
        ...
        NYA_CERR << "Failed to map texture! (error code: " << NYA_PRINT_HEX( operationResult ) << ")" << std::endl;
    }
}
#endif
