...
compile_shader_PS( "Lighting/UberSurface.hlsl", "SurfaceStandard", "EntryPointPS", { "PA_SHADING_MODEL": "SHADING_MODEL_STANDARD", "PA_EDITOR": "1" } )
compile_shader_PS( "Lighting/UberSurface.hlsl", "SurfaceClearCoat", "EntryPointPS", { "PA_SHADING_MODEL": "SHADING_MODEL_CLEAR_COAT", "PA_EDITOR": "1" } )
compile_shader_PS( "Lighting/UberSurface.hlsl", "SurfaceEmissive", "EntryPointPS", { "PA_SHADING_MODEL": "SHADING_MODEL_EMISSIVE", "PA_DONT_RECEIVE_SHADOWS": "1", "PA_EDITOR": "1" } )
...
compile_shader_PS( "Lighting/UberSurface.hlsl", "SurfaceStandardProbeCapture", "EntryPointPS", { "PA_SHADING_MODEL": "SHADING_MODEL_STANDARD", "PA_EDITOR": "1", "PA_PROBE_CAPTURE" : "1" } )
compile_shader_PS( "Lighting/UberSurface.hlsl", "SurfaceClearCoatProbeCapture", "EntryPointPS", { "PA_SHADING_MODEL": "SHADING_MODEL_CLEAR_COAT", "PA_EDITOR": "1", "PA_PROBE_CAPTURE" : "1" } )
compile_shader_PS( "Lighting/UberSurface.hlsl", "SurfaceEmissiveProbeCapture", "EntryPointPS", { "PA_SHADING_MODEL": "SHADING_MODEL_EMISSIVE", "PA_EDITOR": "1", "PA_DONT_RECEIVE_SHADOWS": "1", "PA_PROBE_CAPTURE" : "1" } )
